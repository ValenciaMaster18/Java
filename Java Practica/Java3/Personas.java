...
public abstract class Personas {
    ...
    public Personas(){
        ...
        //entre 0 y 1
        int determinar_sexo=Aleatorio.generaNumeroAleatorio(0,1);

        //Si es 0 es un chico
        if(determinar_sexo==CHICO){
            nombre=NOMBRES_CHICOS[Aleatorio.generaNumeroAleatorio(0,4)];
            sexo='H';
        }else{
            nombre=NOMBRES_CHICAS[Aleatorio.generaNumeroAleatorio(0,4)];
            sexo='M';
        }
